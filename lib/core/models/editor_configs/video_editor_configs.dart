...
class VideoEditorConfigs {
  ...
  VideoEditorConfigs copyWith({
    ...
    return VideoEditorConfigs(
      ...
      trimBarInvertMouseScroll: trimBarInvertMouseScroll ?? this.trimBarInvertMouseScroll,
      isAudioSupported: isAudioSupported ?? this.isAudioSupported,
      enablePlayButton: enablePlayButton ?? this.enablePlayButton,
      enableEstimatedFileSize: enableEstimatedFileSize ?? this.enableEstimatedFileSize,
      trimBarMinScale: trimBarMinScale ?? this.trimBarMinScale,
      trimBarMaxScale: trimBarMaxScale ?? this.trimBarMaxScale,
      playTimeSmoothingDuration: playTimeSmoothingDuration ?? this.playTimeSmoothingDuration,
      minTrimDuration: minTrimDuration ?? this.minTrimDuration,
      controlsPosition: controlsPosition ?? this.controlsPosition,
      animatedIndicatorDuration: animatedIndicatorDuration ?? this.animatedIndicatorDuration,
      animatedIndicatorSwitchInCurve: animatedIndicatorSwitchInCurve ?? this.animatedIndicatorSwitchInCurve,
      animatedIndicatorSwitchOutCurve: animatedIndicatorSwitchOutCurve ?? this.animatedIndicatorSwitchOutCurve,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is VideoEditorConfigs &&
        ...
        other.animatedIndicatorSwitchInCurve == animatedIndicatorSwitchInCurve &&
        other.animatedIndicatorSwitchOutCurve == animatedIndicatorSwitchOutCurve;
  }
